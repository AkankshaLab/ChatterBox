...
const Login = () => {
  return (
    <div className='flex flex-col items-center justify-center min-w-[384px] mx-auto'>
        <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
            ...
            <form>
              ...
              <div>
              <button className='btn btn-block btn-sm mt-2 bg-blue-500 hover:bg-blue-700 text-white border-0'>Login</button>
              </div>
            </form>
        </div>
    </div>
